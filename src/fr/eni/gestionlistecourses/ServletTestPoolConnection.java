...
public class ServletTestPoolConnection extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			DataSource dataSource = (DataSource)context.lookup("java:comp/env/jdbc/cnx");
			//Demande une connexion. La méthode getConnection met la demande en attente tant qu'il n'y a pas
			//de connexion disponnible dans le pool
			Connection cnx = dataSource.getConnection();
			out.print("La connexion est " + (cnx.isClosed()?"fermée":"ouverte")+".");
			//Libérer la connexion lorsque l'on a plus besoin:
